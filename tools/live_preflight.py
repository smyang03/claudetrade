...
LIVE_CONFIG_KEYS = {
    ...
    "PATHB_EARLY_JUDGE_AFFORDABILITY_PREFILTER_ENABLED",
    "PATHB_EARLY_JUDGE_AFFORDABILITY_PULLBACK_BUFFER_PCT",
    "PATHB_SELECTION_PRICE_PREFILTER_ENABLED",
    "EARLY_JUDGE_MAX_CALLS_PER_TICKER_PER_SESSION",
    "EARLY_JUDGE_RECHECK_CONSUMER_ENABLED",
    "EARLY_JUDGE_RECHECK_DEFAULT_MIN",
    "EARLY_JUDGE_RECHECK_MAX_AGE_MIN",
    "EARLY_JUDGE_RECHECK_MAX_ATTEMPTS",
    "WATCH_TRIGGER_REASK_CLAUDE_ENABLED",
    "WATCH_TRIGGER_SHADOW_MAX_EVALS_PER_TICKER_PER_ROUND",
    "ADAPTIVE_REASK_CLAUDE_BRIDGE_ENABLED",
    "ADAPTIVE_REASK_CLAUDE_MAX_PER_CYCLE",
    "PATHB_MAX_POSITIONS",
    ...
    "TRADE_READY_PRIORITY_SORT_ENABLED",
    "PROFIT_EVIDENCE_GATE_MODE",
    "PROFIT_EVIDENCE_GATE_MODE_KR",
    "PROFIT_EVIDENCE_GATE_MODE_US",
    "PROFIT_EVIDENCE_GATE_MODE_PATH_A",
    ...
    "PROFIT_EVIDENCE_SNAPSHOT_PATH",
    "PROFIT_EVIDENCE_MAX_AGE_MIN",
    "PROFIT_EVIDENCE_MIN_PROB",
    "PROFIT_EVIDENCE_MIN_EXPECTED_NET_PCT",
    "PROFIT_EVIDENCE_MIN_COST_PCT_KR",
    "PROFIT_EVIDENCE_MIN_COST_PCT_US",
    "PROFIT_EVIDENCE_MAX_UNCERTAINTY",
    "PROFIT_EVIDENCE_MIN_VALIDATION_N",
    "PROFIT_EVIDENCE_MIN_VALIDATION_NET_LCB_PCT",
    "PROFIT_EVIDENCE_MAX_CALIBRATION_ECE",
    "PROFIT_PATH_SHADOW_ENABLED",
    "PROFIT_PATH_SHADOW_ENABLED_KR",
