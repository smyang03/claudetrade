...
def _path_b_config(runtime_mode: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "us_zone_fill_mode": str(env.get("PATHB_ZONE_FILL_MODE_US", "shadow") or "shadow"),
        "us_zone_fill_top_threshold": _env_float(env, "PATHB_ZONE_FILL_TOP_THRESHOLD", 0.67),
        "us_zone_fill_reward_threshold_pct": _env_float(env, "PATHB_ZONE_FILL_REWARD_PCT", 5.0),
        "us_gap_pullback_live_enabled": _env_bool(env, "US_GAP_PULLBACK_LIVE_ENABLED", False),
