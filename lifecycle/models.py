...
class LifecycleEventType(str, Enum):
    ...
    CLAUDE_PRICE_PLAN_GATE_WARNING = "CLAUDE_PRICE_PLAN_GATE_WARNING"
    ...
    PATHB_SELECTION_RECONCILE = "PATHB_SELECTION_RECONCILE"
    PATHB_SELECTION_RECONCILE_ERROR = "PATHB_SELECTION_RECONCILE_ERROR"
