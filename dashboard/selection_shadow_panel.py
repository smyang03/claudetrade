...
function renderSelectionShadow(d) {
  ...
  html += ssTable('실험',experiments,[['시장','market'],['버전','version'],['최초 관측','first_observed_at'],['원래 실험 코드 지문','code_fingerprint'],['파라미터 지문','parameter_fingerprint'],['고정 파라미터','parameters']]);
  html += '<p>관측 완전성: OBSERVED_PARTIAL은 일부 관측 기록이며 전체 세션 관측 완료를 뜻하지 않습니다.</p>';
  html += ssTable('세션 관측 결손',d.coverage||[],[['시장','market'],['세션','session_date'],['관측 상태','status'],['실제 진단 시각','diagnosed_at']]);
