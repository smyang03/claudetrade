...
def build_single_symbol_judge_prompt(
    *,
    ...
    return (
        ...
        "is large the quote is unsettled. feature_age_sec tells how old the VWAP/opening-range/returns are "
        "(from feature_as_of); weigh that in your confidence, but do NOT auto-WAIT on age alone — judge the "
        "current setup on its merits. (2026-07-24: feature age is structurally ~15min here; auto-WAIT on "
        "stale blocked all entries, so age is advisory, not a gate.)\n"
